...
from base.data import fetch_data_paths
...
class ImageDataset(Dataset):
    ...
    def __init__(self, dataset: str, subset: str,
        ...
        self.subset = subset
        self.paths = fetch_data_paths(
            self.dataset, self.subset, metadata=False)
    ...
    def __getitem__(self, item):
        ...
        if self.augmenter is not None:
            patch, centers, params, augment_dict = self.augmenter.transform(
                patch, centers, params)
